...
for _, row in failures_extremes.iterrows():
    ...
    plt.plot(model_data[Constants.ID], model_data[Constants.FAILURES], alpha=0.7)
    ...
    plt.savefig(os.path.join(output_dir, f'{model_name}_failures_plot.svg'), format='svg')
